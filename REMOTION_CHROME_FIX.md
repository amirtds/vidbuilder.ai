...
# Install all required libraries (Ubuntu 24.04 uses t64 variants)
...
**Note:** Ubuntu 24.04 uses `t64` suffix for some packages (transition to 64-bit time_t). The script handles this automatically.
